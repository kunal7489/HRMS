                                                    ...
                                                    <div class="signup-form">
                                                        ...
                                                        <form onSubmit={handleSubmit} class="mt-5 border p-4 bg-light shadow">
                                                            <div style={{ textAlign: 'center' }}>
                                                                <h4 style={{ display: 'inline'}} className="mb-5 text-secondary">Add new skills</h4>
                            ...
                            <table className="table">
                                <thead className="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col" onClick={() => handleSort('skills')}> skills {sortColumn === 'skills' && (
                                            <FontAwesomeIcon icon={sortDirection === 'ascending' ? faSortUp : faSortDown} />
                                        )}</th>
                                        <th scope="col" onClick={() => handleSort('profile')}> Profile {sortColumn === 'profile' && (
                                            <FontAwesomeIcon icon={sortDirection === 'ascending' ? faSortUp : faSortDown} />
                                        )}</th>
                                        <th scope="col" onClick={() => handleSort('description')}> Description {sortColumn === 'description' && (
                                            <FontAwesomeIcon icon={sortDirection === 'ascending' ? faSortUp : faSortDown} />
                                        )}</th>
