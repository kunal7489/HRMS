...
import { Link } from 'react-router-dom';
     ...
     const ProfileModule = () => {
        ...
        const Deletemulti = async () => {
            ...
            try {
                const response = await axios.delete(`${BASE_API_URL}profiles/multiDelete`, {
        ...
        const DeleteData = (id) => {
            ...
            if (isConfirmed) {
                ...
                try {
                    console.log('id', id)
                    const response = axios.delete(`${BASE_API_URL}profiles/delete?id=${id}`)
                                                    ...
                                                    <div class="signup-form">
                                                        ...
                                                        <form onSubmit={handleSubmit} class="mt-5 border p-4 bg-light shadow">
                                                            <div style={{ textAlign: 'center' }}>
                                                                <h4 style={{ display: 'inline'}} className="mb-5 text-secondary">Add new profile</h4>
                            ...
                            <table className="table">
                                <thead className="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col" onClick={() => handleSort('profile')}> profile {sortColumn === 'profile' && (
                                            <FontAwesomeIcon icon={sortDirection === 'ascending' ? faSortUp : faSortDown} />
                                        )}</th>
                                        <th scope="col" onClick={() => handleSort('profile_id')}> Profile Id {sortColumn === 'profile_id' && (
                                            <FontAwesomeIcon icon={sortDirection === 'ascending' ? faSortUp : faSortDown} />
                                        )}</th>
